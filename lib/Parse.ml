...
let children_regexps : (string * Run.exp option) list = [
  ...
  "pat_56631e5", None;
  "optional_semi", None;
  "string_literal_content", None;
  "comment", None;
  "interpolation_string_content", None;
  "pat_3df6e71", None;
  "tok_pat_245b2d0", None;
  "boolean_literal",
  Some (
    Alt [|
      Token (Literal "true");
  ...
  Some (
    Alt [|
      Token (Name "tok_choice_pat_8eb8081");
      Token (Name "tok_pat_245b2d0");
    |];
  );
  "calling_convention",
  Some (
  ...
  "implicit_parameter_list_with_modifiers",
  Some (
    Seq [
      Token (Name "lambda_paren_open");
      Alt [|
        Seq [
          Repeat1 (
            Alt [|
  ...
  Some (
    Alt [|
      ...
      Token (Name "preproc_if_in_attribute_list");
    |];
  );
  "await_expression",
  Some (
  ...
  Some (
    Seq [
      Token (Name "class_declaration_initializer");
      Token (Name "declaration_list_body");
    ];
  );
  "class_declaration_initializer",
  Some (
    Seq [
      Repeat (
        Token (Name "attribute_list_");
  ...
  Some (
    Alt [|
      ...
      Token (Name "member_access_expression");
      Token (Name "name_invocation_pattern");
      Token (Name "complex_invocation_expression");
      Token (Name "cast_expression");
      Token (Name "simple_name");
      Token (Name "literal");
    |];
  ...
  Some (
    Seq [
      Token (Name "constructor_declaration_initializer");
      Token (Name "function_body");
    ];
  );
  "constructor_declaration_initializer",
  Some (
    Seq [
      Repeat (
        Token (Name "attribute_list_");
  ...
  Some (
    Seq [
      Token (Name "delegate_declaration_initializer");
      Repeat (
        Token (Name "type_parameter_constraints_clause");
      );
      Token (Literal ";");
  ...
  Some (
    Seq [
      Token (Name "enum_declaration_initializer");
      Alt [|
        Seq [
  ...
  "expression_element", Some (Token (Name "expression"););
  ...
  Some (
    Seq [
      Token (Literal "{");
      Repeat (
        Token (Name "extension_member_declaration");
      );
      Token (Literal "}");
      Opt (
        Token (Literal ";");
  ...
  Some (
    Seq [
      Token (Literal "for");
      Token (Name "for_statement_conditions");
      Token (Name "statement");
    ];
  );
  ...
  Some (
    Seq [
      Token (Name "foreach_statement_initializer");
      Token (Name "statement");
    ];
  );
  "foreach_statement_initializer",
  Some (
    Seq [
      Opt (
        Token (Literal "await");
  ...
  Some (
    Seq [
      Token (Name "interface_declaration_initializer");
      Token (Name "declaration_list_body");
    ];
  );
  "interface_declaration_initializer",
  Some (
    Seq [
      Repeat (
        Token (Name "attribute_list_");
  ...
  Some (
    Seq [
      Token (Name "lambda_expression_init");
      Token (Literal "=>");
      Alt [|
        Token (Name "block");
        Token (Name "expression");
  ...
  Some (
    Alt [|
      Token (Name "parameter_list");
      Token (Name "identifier");
      Token (Name "implicit_parameter_list_with_modifiers");
    |];
  );
  "let_clause",
  Some (
  ...
  Some (
    Alt [|
      ...
      Token (Name "collection_expression");
      ...
      Token (Name "address_of_expression");
  ...
  "parenthesized_pattern_with_designation",
  Some (
    Seq [
      Token (Literal "(");
      Token (Name "pattern");
  ...
  Some (
    Alt [|
      ...
      Token (Name "parenthesized_pattern_with_designation");
  ...
  Some (
    Seq [
      ...
      Opt (
        Alt [|
          Token (Name "preproc_else_in_attribute_list");
          Token (Name "preproc_elif_in_attribute_list");
        |];
      );
    ];
  );
  ...
  Some (
    Seq [
      Token (Name "record_declaration_initializer");
      Token (Name "declaration_list_body");
    ];
  );
  "record_declaration_initializer",
  Some (
    Seq [
      Repeat (
        Token (Name "attribute_list_");
  ...
  Some (
    Seq [
      Token (Name "struct_declaration_initializer");
      Token (Name "declaration_list_body");
    ];
  );
  "struct_declaration_initializer",
  Some (
    Seq [
      Repeat (
        Token (Name "attribute_list_");
  ...
  Some (
    Seq [
      ...
      Token (Name "switch_expression_body");
    ];
  );
...
let trans_tok_choice_pat_8eb8081 ((kind, body) : mt) : CST.tok_choice_pat_8eb8081 =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_lambda_paren_open ((kind, body) : mt) : CST.lambda_paren_open =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_tok_pat_245b2d0 ((kind, body) : mt) : CST.tok_pat_245b2d0 =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_escape_sequence ((kind, body) : mt) : CST.escape_sequence =
  ...
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Tok_choice_pat_8eb8081 (
            trans_tok_choice_pat_8eb8081 (Run.matcher_token v)
          )
      | Alt (1, v) ->
          `Tok_pat_245b2d0 (
            trans_tok_pat_245b2d0 (Run.matcher_token v)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
let trans_implicit_parameter_list_with_modifiers ((kind, body) : mt) : CST.implicit_parameter_list_with_modifiers =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
          (
            trans_lambda_paren_open (Run.matcher_token v0),
            (match v1 with
            | Alt (0, v) ->
                `Rep1_choice_scoped_id (
                  (match v with
                  | Seq [v0; v1] ->
                      (
                        Run.repeat1
...
let rec trans_accessor_declaration ((kind, body) : mt) : CST.accessor_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2; v3] ->
          (
            Run.repeat
              (fun v -> trans_attribute_list_ (Run.matcher_token v))
              v0
            ,
            Run.repeat
...
and trans_address_of_expression ((kind, body) : mt) : CST.address_of_expression =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
and trans_attribute_list_ ((kind, body) : mt) : CST.attribute_list_ =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Attr_list (
            trans_attribute_list (Run.matcher_token v)
          )
      | Alt (1, v) ->
          `Prep_if_in_attr_list (
            trans_preproc_if_in_attribute_list (Run.matcher_token v)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
          ...
          (
            ...
            Run.repeat
              (fun v ->
                ...
                | Alt (0, v) ->
                    `Catch_decl (
                      trans_catch_declaration (Run.matcher_token v)
                    )
                | Alt (1, v) ->
                    `Catch_filter_clause (
                      trans_catch_filter_clause (Run.matcher_token v)
                    )
                | _ -> assert false
                )
              )
...
and trans_class_declaration ((kind, body) : mt) : CST.class_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_class_declaration_initializer (Run.matcher_token v0),
            trans_declaration_list_body (Run.matcher_token v1)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false

and trans_class_declaration_initializer ((kind, body) : mt) : CST.class_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5] ->
          (
            ...
            Run.repeat
              (fun v ->
                ...
                | Alt (0, v) ->
                    `Type_param_list (
                      trans_type_parameter_list (Run.matcher_token v)
                    )
                | Alt (1, v) ->
                    `Param_list (
                ...
                | Alt (2, v) ->
                    `Base_list (
                      trans_base_list (Run.matcher_token v)
                    )
                | _ -> assert false
                )
              )
...
and trans_collection_element ((kind, body) : mt) : CST.collection_element =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Exp_elem (
            trans_expression_element (Run.matcher_token v)
          )
      | Alt (1, v) ->
          `Spread_elem (
...
and trans_collection_expression ((kind, body) : mt) : CST.collection_expression =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
          (
            ...
            Run.opt
              (fun v ->
                ...
                | Seq [v0; v1; v2] ->
                    (
                      trans_collection_element (Run.matcher_token v0),
                      Run.repeat
                        (fun v ->
                          (match v with
                          | Seq [v0; v1] ->
                              (
                                Run.trans_token (Run.matcher_token v0),
                                trans_collection_element (Run.matcher_token v1)
                              )
                          | _ -> assert false
                          )
                        )
...
and trans_complex_invocation_expression ((kind, body) : mt) : CST.complex_invocation_expression =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
and trans_constant_pattern ((kind, body) : mt) : CST.constant_pattern =
  ...
  | Children v ->
      ...
      | Alt (10, v) ->
          `Name_invo_pat (
            trans_name_invocation_pattern (Run.matcher_token v)
          )
      | Alt (11, v) ->
          `Comp_invo_exp (
            trans_complex_invocation_expression (Run.matcher_token v)
          )
      | Alt (12, v) ->
          `Cast_exp (
            trans_cast_expression (Run.matcher_token v)
...
and trans_constructor_declaration ((kind, body) : mt) : CST.constructor_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_constructor_declaration_initializer (Run.matcher_token v0)
            ,
...
and trans_constructor_declaration_initializer ((kind, body) : mt) : CST.constructor_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4] ->
...
and trans_declaration_list_body ((kind, body) : mt) : CST.declaration_list_body =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Decl_list_opt_semi (
            ...
            | Seq [v0; v1] ->
                (
                  trans_declaration_list (Run.matcher_token v0),
                  trans_optional_semi (Run.matcher_token v1)
                )
            | _ -> assert false
            )
          )
...
and trans_delegate_declaration ((kind, body) : mt) : CST.delegate_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            trans_delegate_declaration_initializer (Run.matcher_token v0)
            ,
            Run.repeat
              (fun v ->
                trans_type_parameter_constraints_clause (Run.matcher_token v)
...
and trans_delegate_declaration_initializer ((kind, body) : mt) : CST.delegate_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6] ->
...
and trans_enum_declaration ((kind, body) : mt) : CST.enum_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_enum_declaration_initializer (Run.matcher_token v0),
            (match v1 with
            | Alt (0, v) ->
                `Enum_member_decl_list_opt_semi (
                  (match v with
                  | Seq [v0; v1] ->
                      (
                        trans_enum_member_declaration_list (Run.matcher_token v0),
                        trans_optional_semi (Run.matcher_token v1)
                      )
                  | _ -> assert false
                  )
...
and trans_enum_declaration_initializer ((kind, body) : mt) : CST.enum_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4] ->
...
and trans_expression_element ((kind, body) : mt) : CST.expression_element =
  match body with
  | Children v ->
      trans_expression (Run.matcher_token v)
  | Leaf _ -> assert false
...
and trans_extension_body ((kind, body) : mt) : CST.extension_body =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
          (
            ...
            Run.repeat
              (fun v ->
                trans_extension_member_declaration (Run.matcher_token v)
              )
              v1
            ,
            Run.trans_token (Run.matcher_token v2),
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2; v3; v4; v5; v6; v7] ->
          (
            ...
            ,
            Run.trans_token (Run.matcher_token v3),
            trans_receiver_parameter (Run.matcher_token v4),
            Run.trans_token (Run.matcher_token v5),
            Run.repeat
              (fun v ->
                trans_type_parameter_constraints_clause (Run.matcher_token v)
              ...
              v6
            ,
            trans_extension_body (Run.matcher_token v7)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false

and trans_extension_member_declaration ((kind, body) : mt) : CST.extension_member_declaration =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
and trans_for_statement ((kind, body) : mt) : CST.for_statement =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            Run.trans_token (Run.matcher_token v0),
            trans_for_statement_conditions (Run.matcher_token v1),
...
and trans_for_statement_conditions ((kind, body) : mt) : CST.for_statement_conditions =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6] ->
...
and trans_foreach_statement ((kind, body) : mt) : CST.foreach_statement =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_foreach_statement_initializer (Run.matcher_token v0),
            trans_statement (Run.matcher_token v1)
          )
      | _ -> assert false
      )
...
and trans_foreach_statement_initializer ((kind, body) : mt) : CST.foreach_statement_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6] ->
...
and trans_interface_declaration ((kind, body) : mt) : CST.interface_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_interface_declaration_initializer (Run.matcher_token v0)
            ,
            trans_declaration_list_body (Run.matcher_token v1)
          )
      | _ -> assert false
...
and trans_interface_declaration_initializer ((kind, body) : mt) : CST.interface_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6] ->
...
and trans_lambda_expression ((kind, body) : mt) : CST.lambda_expression =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            trans_lambda_expression_init (Run.matcher_token v0),
            Run.trans_token (Run.matcher_token v1),
            (match v2 with
            | Alt (0, v) ->
                `Blk (
...
and trans_lambda_expression_init ((kind, body) : mt) : CST.lambda_expression_init =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
...
and trans_lambda_parameters ((kind, body) : mt) : CST.lambda_parameters =
  ...
  | Children v ->
      ...
      | Alt (2, v) ->
          `Impl_param_list_with_modifs (
            trans_implicit_parameter_list_with_modifiers (Run.matcher_token v)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
and trans_local_function_statement ((kind, body) : mt) : CST.local_function_statement =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            trans_local_function_declaration (Run.matcher_token v0),
            Run.repeat
              (fun v ->
                trans_type_parameter_constraints_clause (Run.matcher_token v)
              )
...
and trans_name_invocation_pattern ((kind, body) : mt) : CST.name_invocation_pattern =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
and trans_non_lvalue_expression ((kind, body) : mt) : CST.non_lvalue_expression =
  ...
  | Children v ->
      ...
      | Alt (12, v) ->
          `Coll_exp (
            trans_collection_expression (Run.matcher_token v)
          )
      | Alt (13, v) ->
          `Switch_exp (
      ...
      | Alt (22, v) ->
          `Addr_of_exp (
            trans_address_of_expression (Run.matcher_token v)
          )
      | Alt (23, v) ->
          `Reft_exp (
...
and trans_parameter ((kind, body) : mt) : CST.parameter =
  ...
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Rep_attr_list__opt_rep_choice_this_type_id_opt_EQ_exp (
            (match v with
            | Seq [v0; v1; v2; v3] ->
                (
                  Run.repeat
...
and trans_parenthesized_pattern_with_designation ((kind, body) : mt) : CST.parenthesized_pattern_with_designation =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
          (
            ...
            trans_pattern (Run.matcher_token v1),
            Run.trans_token (Run.matcher_token v2),
            trans_variable_designation (Run.matcher_token v3)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
and trans_pattern ((kind, body) : mt) : CST.pattern =
  ...
  | Children v ->
      ...
      | Alt (6, v) ->
          `Paren_pat_with_desi (
            trans_parenthesized_pattern_with_designation (Run.matcher_token v)
          )
      | Alt (7, v) ->
          `Paren_pat (
...
and trans_preproc_elif_in_attribute_list ((kind, body) : mt) : CST.preproc_elif_in_attribute_list =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4] ->
          (
            ...
            Run.opt
              (fun v ->
                (match v with
                | Alt (0, v) ->
                    `Prep_else_in_attr_list (
                      trans_preproc_else_in_attribute_list (Run.matcher_token v)
                    )
                | Alt (1, v) ->
                    `Prep_elif_in_attr_list (
                      trans_preproc_elif_in_attribute_list (Run.matcher_token v)
                    )
                | _ -> assert false
                )
              )
...
and trans_preproc_else_in_attribute_list ((kind, body) : mt) : CST.preproc_else_in_attribute_list =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
and trans_preproc_if_in_attribute_list ((kind, body) : mt) : CST.preproc_if_in_attribute_list =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5] ->
...
and trans_record_declaration ((kind, body) : mt) : CST.record_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_record_declaration_initializer (Run.matcher_token v0),
            trans_declaration_list_body (Run.matcher_token v1)
          )
      | _ -> assert false
      )
...
and trans_record_declaration_initializer ((kind, body) : mt) : CST.record_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6; v7] ->
...
and trans_recursive_pattern ((kind, body) : mt) : CST.recursive_pattern =
  ...
  | Children v ->
      ...
      | Alt (0, v) ->
          `Name_posi_pat_clause_opt_prop_pat_clause_var_desi (
            ...
            | Seq [v0; v1; v2; v3] ->
                (
                  trans_name (Run.matcher_token v0),
                  trans_positional_pattern_clause (Run.matcher_token v1),
                  Run.opt
                    (fun v ->
      ...
      | Alt (1, v) ->
          `Name_posi_pat_clause_opt_prop_pat_clause (
            (match v with
            | Seq [v0; v1; v2] ->
                (
                  trans_name (Run.matcher_token v0),
      ...
      | Alt (3, v) ->
          `Posi_pat_clause (
            trans_positional_pattern_clause (Run.matcher_token v)
          )
      | Alt (4, v) ->
      ...
      | Alt (5, v) ->
          `Choice_posi_pat_clause_prop_pat_clause_opt_var_desi (
            (match v with
            | Seq [v0; v1] ->
                (
                  (match v0 with
                  | Alt (0, v) ->
                      `Posi_pat_clause_prop_pat_clause (
                        (match v with
                        | Seq [v0; v1] ->
                            (
                              trans_positional_pattern_clause (Run.matcher_token v0),
                              trans_property_pattern_clause (Run.matcher_token v1)
                            )
                        | _ -> assert false
                        )
                      )
...
and trans_struct_declaration ((kind, body) : mt) : CST.struct_declaration =
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            trans_struct_declaration_initializer (Run.matcher_token v0),
            trans_declaration_list_body (Run.matcher_token v1)
          )
      | _ -> assert false
      )
...
and trans_struct_declaration_initializer ((kind, body) : mt) : CST.struct_declaration_initializer =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5; v6] ->
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            trans_expression (Run.matcher_token v0),
            Run.trans_token (Run.matcher_token v1),
            trans_switch_expression_body (Run.matcher_token v2)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
and trans_switch_expression_body ((kind, body) : mt) : CST.switch_expression_body =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
...
and trans_with_body ((kind, body) : mt) : CST.with_body =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3] ->
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            trans_expression (Run.matcher_token v0),
            Run.trans_token (Run.matcher_token v1),
            trans_with_body (Run.matcher_token v2)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
